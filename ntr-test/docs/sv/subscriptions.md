# Registrering för utbildningstillfällen - Registrera dig för utbildningstillfällen
...
En registrering är en intresseanmälan för att delta i ett utbildningstillfälle. Det är som att "reservera en plats" - du visar intresse men förbinder dig inte att faktiskt delta.
